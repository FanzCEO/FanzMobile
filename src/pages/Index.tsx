...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-background max-w-sm mx-auto relative overflow-hidden">
      {/* Mobile Status Bar */}
      <div className={`h-6 ${isDark ? "bg-black" : "bg-gray-900"} flex items-center justify-between px-4 text-white text-xs`}>
        <span>9:41</span>
      ...
      {showAdminBackButton && (
        <div className="fixed bottom-0 left-1/2 transform -translate-x-1/2 w-full max-w-sm bg-red-50 dark:bg-red-950/50 border-t border-red-200 dark:border-red-800 p-2 space-y-2">
          <Button 
            variant="outline" 
            size="sm" 
            className="w-full"
