...
class SocialSharingService {
  ...
  private async generateShareContent(content: any, template: SocialShareTemplate, customizations?: any): Promise<{
    ...
    const shareUrl = `https://share.fanzmobile.com/${content.id}/${template.id}`;
    const previewUrl = `https://cdn.fanzmobile.com/previews/social_${Date.now()}.jpg`;
