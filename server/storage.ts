...
export class DatabaseStorage implements IStorage {
  ...
  async anonymizeUserData(userId: string): Promise<void> {
    ...
    await db.update(users)
      .set({
        email: `deleted_user_${userId}@fanzmobile.com`,
  ...
  async getSystemSetting(key: string): Promise<any | undefined> {
    ...
    const settings: { [key: string]: any } = {
      'app_name': { key: 'app_name', value: 'FanzMobile', type: 'string' },
  ...
  async getEmailSettings(): Promise<any> {
    return {
      ...
      smtpPort: 587,
      smtpUsername: 'noreply@fanzmobile.com',
      smtpPassword: '****',
      smtpSecure: true,
      fromEmail: 'noreply@fanzmobile.com',
      fromName: 'FanzMobile',
      replyToEmail: 'support@fanzmobile.com',
      maxSendRate: 100,
      isActive: true,
