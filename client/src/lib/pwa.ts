...
class FanzMobilePWAManager {
  ...
  async init(): Promise<void> {
    try {
      ...
      console.log('🚀 FanzMobile PWA Manager initialized successfully');
    } catch (error) {
...
export const pwaManager = new FanzMobilePWAManager();
