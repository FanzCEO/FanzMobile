// FanzMobile PWA Offline Storage
...
class FanzMobileOfflineStorage {
  private db: IDBDatabase | null = null;
  private readonly dbName = 'FanzMobilePWA';
  ...
  async initDB(): Promise<void> {
    return new Promise((resolve, reject) => {
      ...
      request.onsuccess = () => {
        ...
        console.log('✅ FanzMobile IndexedDB initialized');
        resolve();
      };
...
export const offlineStorage = new FanzMobileOfflineStorage();
