      ...
      <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col justify-center space-y-8 p-8">
          <div className="text-center lg:text-left">
            <h1 className="text-5xl font-bold font-heading mb-4 bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">
              FanzMobile
            </h1>
            <p className="text-xl neon-white-body neon-breathe mb-8">
              Enterprise cloud drive for media processing, compliance, and AI automation. Secure storage for content creators.
            </p>
          </div>
          ...
          <div className="bg-card/30 rounded-lg p-6 border border-accent/20">
            <div className="flex items-center space-x-3 mb-3">
              ...
              <h3 className="font-semibold neon-crimson-heading neon-dying">Why Choose FanzMobile?</h3>
            </div>
            <ul className="space-y-2 text-sm neon-white-body">
              <li>• Enterprise-grade cloud storage with 500GB free</li>
              <li>• AI-powered media processing and optimization</li>
              <li>• 2257 compliance automation and record keeping</li>
              <li>• Multi-format support with CDN distribution</li>
