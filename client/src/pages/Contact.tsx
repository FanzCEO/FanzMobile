...
const FAQ = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "FanzMobile offers flexible pricing plans starting with 500GB free storage. Premium plans include additional storage, AI processing credits, and priority support."
    },
    {
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-2">
                <p className="text-sm">FanzMobile HQ</p>
