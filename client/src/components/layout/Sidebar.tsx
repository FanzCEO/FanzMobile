    ...
    <div className="flex h-full flex-col">
      ...
      <div className="flex h-16 md:h-20 items-center px-4 md:px-6 border-b border-border">
        <div className="flex items-center gap-2 md:gap-3">
          <div className="h-8 md:h-12 w-8 md:w-12 bg-gradient-to-br from-blue-500 to-purple-600 rounded-xl flex items-center justify-center">
            <svg className="w-5 md:w-7 h-5 md:h-7 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z"/>
            </svg>
          </div>
          <div className="flex flex-col">
            <span className="font-bold text-lg md:text-xl text-blue-400 tracking-wider">FanzMobile</span>
            <span className="text-xs text-slate-400 font-semibold tracking-wide uppercase hidden sm:block">Cloud Drive</span>
          </div>
        </div>
      </div>
