      ...
      <div className="relative z-10">
        ...
        <div className="text-center mt-8 space-y-4">
          ...
          <div className="text-gray-400 text-sm tracking-wide">
            ...
            {progress >= 90 && "✨ Welcome to FanzMobile Cloud Drive"}
          </div>
        </div>
      </div>
...
function FullExperienceContent({ 
  ...
  return (
    <div className="text-center space-y-8">
      {/* Neon FanzMobile logo */}
      <div className="relative">
        <h1
          className="text-6xl font-black uppercase tracking-wider text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-purple-500 to-cyan-500"
          style={{
        ...
        <div className="absolute inset-0 text-6xl font-black uppercase tracking-wider text-blue-500 opacity-50 blur-sm animate-pulse">
          FANZMOBILE
        </div>
      </div>
...
function QuickLoadContent({ progress }: { progress: number }) {
  return (
    <div className="text-center space-y-6">
      <div className="text-4xl font-bold text-blue-400 uppercase tracking-widest animate-pulse">
        FanzMobile
      </div>
    ...
    <div className="text-center">
      <div className="relative">
        ...
        <div className="absolute inset-0 w-32 h-32 mx-auto flex items-center justify-center">
          <div className="text-2xl font-bold text-white uppercase">FM</div>
        </div>
      </div>
    </div>
  );
...
function SmokeFadeContent() {
  return (
    <div className="text-center space-y-8">
      <div className="relative">
        <div className="text-5xl font-bold text-blue-400 opacity-90 animate-pulse">
          FanzMobile
        </div>
        <div className="absolute inset-0 text-5xl font-bold text-blue-400 blur-md opacity-50 animate-pulse">
          FanzMobile
        </div>
      </div>
