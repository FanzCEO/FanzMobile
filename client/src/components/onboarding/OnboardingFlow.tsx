...
export default function OnboardingFlow({ user, onComplete }: OnboardingFlowProps) {
  ...
  const completeOnboardingMutation = useMutation({
    ...
    onSuccess: () => {
      toast({
        title: "Welcome to FanzMobile!",
        description: "Your profile is now set up. Start exploring the cloud drive!",
      });
  ...
  const steps = [
    {
      title: "Welcome to FanzMobile",
      description: "Cloud Drive for Creators",
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4" data-testid="onboarding-flow">
      <div className="w-full max-w-2xl">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-display font-bold text-primary tracking-wider mb-2">FanzMobile</h1>
    ...
    <div className="text-center space-y-6">
      ...
      <div className="space-y-4">
        ...
        <p className="text-muted-foreground font-body text-lg max-w-lg mx-auto">
          FanzMobile isn't just another platform - it's <span className="text-primary font-semibold">the ultimate cloud drive</span> where
          creators store, process, and distribute content securely. Ready to get started?
        </p>
    ...
    <div className="text-center space-y-6">
      ...
      <div className="space-y-4">
        ...
        <p className="text-lg text-muted-foreground max-w-md mx-auto">
          Your cloud drive is ready. Time to upload, process, and distribute your content with FanzMobile.
        </p>
